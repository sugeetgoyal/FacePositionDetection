...
@property (weak, nonatomic) IBOutlet UILabel *facePositionLabel;
...
- (void)viewDidLoad {
  ...
  self.cameraSwitch.on = YES;
    [self.cameraSwitch setHidden:YES];
    ...
    for (GMVFaceFeature *face in faces) {
      ...
      if (face.hasTrackingID) {
        ...
        if (face.hasHeadEulerAngleY && face.hasHeadEulerAngleZ) {
            if (face.headEulerAngleY < -36.0) {
                self.facePositionLabel.text = @"Looking LEFT";
            } else if (face.headEulerAngleY > 36.0) {
                self.facePositionLabel.text = @"Looking RIGHT";
            } else if ((face.hasLeftEarPosition && face.hasRightEarPosition && face.hasLeftEyePosition && face.hasRightEyePosition) && ((face.leftEarPosition.y < face.leftEyePosition.y) && (face.rightEarPosition.y < face.rightEyePosition.y)) ){
                    self.facePositionLabel.text = @"Looking DOWN";
            } else if ((face.hasNoseBasePosition && face.hasLeftEyePosition && face.hasRightEyePosition) && ((face.noseBasePosition.y - face.leftEyePosition.y) < 10) && ((face.noseBasePosition.y - face.rightEyePosition.y) < 10) ){
                NSLog(@"%f", face.noseBasePosition.y);
                NSLog(@"%f", face.leftEyePosition.y);
                NSLog(@"%f", face.rightEyePosition.y);
                self.facePositionLabel.text = @"Looking UP";
            } else if ((face.headEulerAngleY > -12.0 && face.headEulerAngleY < 12.0)) {
                self.facePositionLabel.text = @"Looking FRONT";
            }  else {
                self.facePositionLabel.text = @"";
            }
        }
